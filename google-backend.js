(function () {
  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    panel.innerHTML = '<section class="masse-lock-card"><div class="masse-lock-mark">MC</div><h1>Masse Coffee</h1><div class="masse-lock-subtitle">Roasting Program</div><button id="googleLoginButton" type="button">Logga in med Google</button><span id="googleLoginStatus">Endast behörigt Google-konto kan öppna programmet.</span></section>';
